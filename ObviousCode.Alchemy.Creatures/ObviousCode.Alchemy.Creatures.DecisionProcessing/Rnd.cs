...
{
	/// <summary>
	/// Rnd is a renamed copy of SimpleRNG, which is a simple 
	/// random number generator based on George Marsaglia's 
	...
	///
	/// Sourced from http://www.codeproject.com/Articles/25172/Simple-Random-Number-Generation
	///
	/// Using this in ObviousCode.Alchemy.Creatures, as opposed to 
	/// the Random class in .NET, simply to ensure consistency
	/// in the highly unlikely scenario of Microsoft changing the
	/// Random algorithm
	/// </summary>
	public class Rnd
	{
